...
app.component('calcView',{
    //restrict:'E',
    templateUrl:'calc-view.html'
});
app.component('textField',{
    //restrict:'E',
    templateUrl:'text-field.html'
});
app.component('numberButtons',{
    //restrict:'E',
    templateUrl:'number-buttons.html'
});
app.component('operatorButtons',{
    //restrict:'E',
    templateUrl:'operator-buttons.html'
});
//})();
